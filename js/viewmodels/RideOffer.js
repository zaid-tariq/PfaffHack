define([], function() {
    function VM() {
      ...
      self.searchAddress = function(){
        url = "http://autocomplete.geocoder.api.here.com/6.2/suggest.json?app_id="+self.APP_ID+"&app_code="+self.APP_CODE+
          "&query="+self.searchQuery()+"&beginHighlight=<b>&endHighlight=</b>"
        $.ajax({
            url: url,
